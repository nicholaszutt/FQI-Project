...
\usepackage{lettrine} % First fancy big letter in text
\usepackage{units}

\usepackage{xcolor} % adding color to words
\usepackage{braket} % braket notation
\usepackage{nameref} % reference name of a section
\usepackage{hyperref} % link to part of document with name
...
% Custom header text
\fancyhead[C]{AP3421-PR Quantum Information Project $\bullet$ April 2020} % $\bullet$ Vol. XXI, No. 1}
...
\usepackage{pdfpages}
\renewcommand{\appendixpagename}{\vspace*{\fill}\centering Appendices 
\vspace*{\fill}}
...
\title{\textbf{IBM Q Backend Analysis using Qiskit}} % Article title
\author{%
\textsc{Jerry Kamer (4294335), Roel van Silfhout (4962141), Nicholas Zutt (5005523)}
\\[1ex]
...
\label{apen} % reference to the appendix
\clearpage

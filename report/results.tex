...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth} \centering % include second image
		...
		\label{fig:swap_density_dev}
	\end{subfigure}
	\caption{ The entanglement swapping density matrices for the ideal simulator, the device and the calibrated device. Data plotted here is taken for 8192 shots on the Melbourne backend. }

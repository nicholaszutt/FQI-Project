...
even, but anharmonicity, introduced through the inclusion of a Josephson tunnel
...
driving frequency for transitions is properly tuned
...
\ref{fig:burlington_connections} and Table \ref{tb:average_errors}, the
Burlington backend has the best gate error rates of any backend we will
consider, with a single-qubit U2 error rate less than 0.065\% for all qubits and
a CNOT error rate of less than 1.645\%.
